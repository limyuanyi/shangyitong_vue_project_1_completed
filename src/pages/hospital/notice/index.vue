<template>
  <div class="notice">
    <h1 class="hosname">{{ hospitalStore.hospitalInfo.hospital?.hosname }}預約挂號須知</h1>
    <div class="top">
    ...
    <div class="info">
      ...
      <div class="text">
        ...
        <br>
        在同一自然日，同一医院，同一科室，同一就诊单元，同一就诊人，可以预约最多1个号源；<br>
        在同一自然周，同一就诊人，可以预约最多8个号源；<br>
        在同一自然月，同一就诊人，可以预约最多12个号源；<br>
        在同一自然季度，同一就诊人，可以预约最多24个号源<br>
      </div>
    </div>
    <div class="info">
      <h2 class="tip">
